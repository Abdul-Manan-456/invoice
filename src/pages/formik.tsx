...
const FormikData: React.FC<formikDataProps> = ({
  ...
  return (
    <main
      className="fixed mb-40 pb-40 space-y-4 md:top-0 top-20 md:left-24 md:pb-8  left-0 md:w-1/2 sm:w-3/4 w-full bg-white h-full rounded-r-lg  overflow-y-scroll no-scrollbar shadow-lg
     dark:bg-medium "
    >
      <Formik
